...
//	SystemClock_Config(SYS_CLK_FREQ_168);
	...
	while (1) {
		...
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, (rcv_buf[0] * 10));
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, (rcv_buf[1] * 10));
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, (rcv_buf[0] * 10));
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, (rcv_buf[1] * 10));
