 ...
 * TIMER4 ch 3 & 4 --> BTS 4 RPWM & LPWM (V4)
 *
 */
...
void movement(float v, float v_w, float angle, float KP, float KD) {
	...
	V1 = ((0.70711 * (-v_x)) + (0.707 * (v_y)) - (0.707 * v_w)) + correction;
	V2 = ((0.70711 * (-v_x)) + (0.707 * (-v_y)) - (0.707 * v_w)) + correction;
	V4 = ((0.70711 * (v_x)) + (0.70711 * (-v_y)) - (0.707 * v_w)) + correction;
	V3 = ((0.70711 * (v_x)) + (0.707 * (v_y)) - (0.707 * v_w)) + correction;

	if (V1 > 0) {
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_1, V1);
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_2, 0);
	} else {
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_1, 0);
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_2, (V1 * (-1)));
	}

	if (V2 > 0) {
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_3, V2);
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_4, 0);
	} else {
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_3, 0);
		__HAL_TIM_SET_COMPARE(&htimer3, TIM_CHANNEL_4, (V2 * (-1)));

	}

	if (V4 > 0) {
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, V4);
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, 0);
	} else {
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, 0);
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, (V4 * (-1)));

	}

	if (V3 > 0) {
		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, V3);
